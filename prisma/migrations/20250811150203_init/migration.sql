...
CREATE TABLE "Protect" (
    ...
    CONSTRAINT "Protect_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "Entity" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Entity" (
    ...
    CONSTRAINT "Entity_proyectId_fkey" FOREIGN KEY ("proyectId") REFERENCES "Proyect" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
